...
# Module-level cache function to avoid instance method caching issues
@lru_cache(maxsize=128)
def _cached_file_read(file_path: str) -> str:
    """Load a file with caching. This is a module-level function to ensure proper caching."""
    try:
...
class PromptLoader:
    ...
    def __init__(self, base_path: str = None):
        if base_path is None:
            # Look for prompts in data/prompts from project root
